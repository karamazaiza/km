package com.example.km; // تأكد من أن الحزمة مطابقة لاسم مشروعك الفعلي
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 1. إخفاء شريط الإجراءات (البار)
        // ملاحظة: هذا الكود يعمل فقط إذا كان المظهر (Theme) يدعم Action Bar.
        // إذا استمر ظهور البار، انتقل إلى ملف themes.xml وغير المظهر إلى NoActionBar
        ...
        // 2. تهيئة RecyclerView
        RecyclerView recyclerView = findViewById(R.id.recycler_view_apps);

        // تعيين LayoutManager لضمان الترتيب العمودي (وهو شرط التصميم)
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        // 3. ربط البيانات والمُهايئ
    ...
    // دالة إنشاء البيانات الوهمية (Mock Data)
    private List<AppItem> createMockData() {
        List<AppItem> data = new ArrayList<>();

        // ************************************************************
        // تم استبدال الأيقونة الوهمية (ic_launcher_background) بأسماء ملفات الأيقونات الجديدة
        // ************************************************************
